...
function CommitSection({
  ...
  const { commitWithPermit, confirming, confirmed, txSignature, entityCurrentAmount, entityStateError } =
  ...
  return (
    <div className="flex flex-col gap-4 items-center">
      <div className="flex flex-col gap-2">
        ...
        <button
          disabled={loading || confirming || !humanReadableAmount || parseFloat(humanReadableAmount) <= 0}
          ...
          onClick={purchase}
        >
          <p className="text-gray-100">{loading || confirming ? "Loading..." : "Commit"}</p>
        </button>

        {confirming && !confirmed && <p className="text-gray-900">Waiting for confirmation...</p>}
