...
For production or any meaningful testing, set the env var `NEXT_PUBLIC_RPC_URL` to your RPC endpoint from [Helius](https://www.helius.dev/), [QuickNode](https://www.quicknode.com/), or [Alchemy](https://www.alchemy.com/).
